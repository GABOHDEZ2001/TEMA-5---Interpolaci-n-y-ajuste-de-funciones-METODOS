...
public class MetodoDeInterpolacionDeLagrange1 {
    ...
    public static void main(String[] args) {
        double[] xValues = {1.0, 3.0}; // Valores de x
        double[] yValues = {2.0, 4.0}; // Valores de y
...
//ENTRADA
//1.0, 3.0; // Valores de x
//2.0, 4.0; // Valores de y

//SALIDA (RESULTADO)
//El valor interpolado en x = 2.0 es 3.0